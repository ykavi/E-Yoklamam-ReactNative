        ...
        return (
            ...
            <LinearGradient colors={['#65BBC9', '#E4ECED']} style={styles.linearGradient}>
                    ...
                    <View style={styles.buttons}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={styles.loginBtn}>
                                <Text style={{ color: '#FFFF', letterSpacing: 1, fontWeight: 'bold' }}>Giriş</Text>
                            </TouchableOpacity>
                ...
                <View style={{ flex: 0.3, alignItems: 'center', paddingBottom: 10, }}>
                    <Text style={{ letterSpacing: 1, color: '#707070' }}>Hesabın yok mu?</Text>
                    <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('RegisterStudent')}
                    >
                        <Text style={{ letterSpacing: 1, color: '#707070', fontWeight: 'bold' }}>Hesap aç</Text>
                    </TouchableOpacity>
                </View>
            </LinearGradient >
